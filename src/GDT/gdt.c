...
//     GDT_ACCESS_DATA_DRIECTION_NORMAL    = 0x00,
...
// void __attribute__((cdec1)) i686_GDT_Load(GDTDescriptor* descriptor, uint16_t codeSegment, uint16_t dataSegment);
